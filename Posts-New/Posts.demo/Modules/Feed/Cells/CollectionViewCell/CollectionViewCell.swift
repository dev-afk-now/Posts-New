...
class CollectionViewCell: FullWidthCollectionViewCell {
    ...
    private lazy var headlineLabel: UILabel = {
        ...
        $0.textColor = .black
        $0.numberOfLines = 0
        $0.font = UIFont.applicatonFont(.bold, size: 20)
        $0.text = "Главная"
    ...
    private lazy var descriptionLabel: UILabel = {
        ...
        $0.textColor = .black
        $0.numberOfLines = 2
        $0.font = UIFont.applicatonFont(.regular, size: 15)
        $0.text = "Description"
        $0.textAlignment = .left
        return $0
    }(UILabel())
    ...
    private lazy var showFullPreviewButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont.applicatonFont(.regular, size: 14)
    ...
    private lazy var likesLabel: UILabel = {
        ...
        $0.textColor = .black
        $0.numberOfLines = 1
        $0.font = UIFont.applicatonFont(.bold, size: 12)
        $0.text = "Description"
    ...
    private lazy var timestampLabel: UILabel = {
        ...
        $0.textColor = .black
        $0.numberOfLines = 1
        $0.font = UIFont.applicatonFont(.regular, size: 12)
        $0.text = "Description"
        $0.textAlignment = .center
        return $0
    }(UILabel())
